...
public class SessionApiController {
    ...
    public void enrollForSession(@RequestBody Person person, @PathVariable("id") int sessionId) throws EnrolException {
    ...
    public void cancelSession(@PathVariable("id") int id){
