...
(CONO      INT  AUTO_INCREMENT  primary key,
 ...
 COVAT     CHAR(11),
 COBANKNO  CHAR(14),
 CONSTRAINT FK_ADDRESS FOREIGN KEY (CO_ANO) REFERENCES ADDRESSES
);
...
(PNO         INT  AUTO_INCREMENT  primary key,
 ...
 PLANG       CHAR(3),
 PA_CONO     INT ,
 CONSTRAINT FK_COMPANY FOREIGN KEY (PA_CONO) REFERENCES COMPANIES ON DELETE SET NULL
);
...
INSERT INTO ADDRESSES VALUES (1,'RING', '189', 'BRUSSEL', '1020 ', 'B');
INSERT INTO ADDRESSES VALUES (2,'AVENUE LAMBERT', '45 B6', 'BRUSSEL', '1060', 'B');
INSERT INTO ADDRESSES VALUES (3,'DIESTSEVEST', '32', 'LEUVEN', '3000', 'B');
INSERT INTO ADDRESSES VALUES (4,'ANTONIUSLAAN', '2', 'GENT', '8200', 'B');
INSERT INTO ADDRESSES VALUES (5,'WARMTESTRAAT', '67', 'NAARDEN', '1411 AR ', 'NL');
INSERT INTO ADDRESSES VALUES (6,'KAAI 345', '67 b5', 'ANTWERPEN', '2030', 'B');
INSERT INTO ADDRESSES VALUES (9,'ZWARTEWEG', '112', 'ROTTERDAM', '1420-WK', 'NL');
INSERT INTO ADDRESSES VALUES (10,'INDUSTRIEPARK', '678', 'MECHELEN', '1240', 'B');
INSERT INTO ADDRESSES VALUES (11,'GOSWELL ROAD', '521', 'LONDON', 'EC1N7JQ', 'GB');
INSERT INTO ADDRESSES VALUES (12,'HELGA FELD', '3', 'MUNICH', '8906', 'D');
INSERT INTO ADDRESSES VALUES (13,'HOOGSTRAAT', '67 ', 'TERNAT', '1200', 'B');
INSERT INTO ADDRESSES VALUES (15,'CORPORATION STREET', '14', 'BIRMINGHAM', 'B2 4RN', 'GB');
INSERT INTO ADDRESSES VALUES (17,'RUE D''EAU', '67', 'NAMUR', '7200', 'B');
INSERT INTO ADDRESSES VALUES (20,'GASTSTRAAT', '243', 'HASSELT', '3500', 'B');
INSERT INTO ADDRESSES VALUES (21,'DESGUINLEI', '109 B56', 'ANTWERPEN', '2030', 'B');
INSERT INTO ADDRESSES VALUES (22,'HOOFDSTRAAT', '675', 'ANTWERPEN', '2000', 'B');
INSERT INTO ADDRESSES VALUES (25,'HEERBAAN', '250', 'AMSTERDAM', '1014 BA', 'NL');
INSERT INTO ADDRESSES VALUES (32,'EXSELSIORLAAN', '67 B45', 'BRUSSEL', '1220', 'B');
INSERT INTO ADDRESSES VALUES (41,'SCHIPHOLWEG', '34', 'LEIDEN', '6574 HK', 'NL');
INSERT INTO ADDRESSES VALUES (42,'WORSHIP STREET', '74', 'LONDON', 'EC2A 2EN', 'GB');
INSERT INTO ADDRESSES VALUES (43,'SCHIEDAMSE VEST', '99A', 'ROTTERDAM', '3012', 'NL');
INSERT INTO ADDRESSES VALUES (46,'GRASMARKT', '67', 'GENT', '8000', 'B');
INSERT INTO ADDRESSES VALUES (52,'AVENUE LOUISE', '78 B4', 'BRUSSEL ', '1000', 'B');
INSERT INTO ADDRESSES VALUES (104,'DEEP LANE', '1A ', 'OXFORD', 'RG211RY', 'GB ');

INSERT INTO COMPANIES VALUES (1, 'LOC COMPUTER CORP.', 1 , '02/6784523 ', '345-786-890', NULL);
INSERT INTO COMPANIES VALUES (2, 'DATAWISHES N.V.', 2, '02/3421632 ', '403-146-747', '210-0040988-09');
INSERT INTO COMPANIES VALUES (3, 'ABIS N.V.', 3, '016/245610', '423-345-567', '739-0000673-02');
INSERT INTO COMPANIES VALUES (4, 'ESCON', 4, '091/456213', '120-450-002', '009-4568791-45');
INSERT INTO COMPANIES VALUES (5, 'COVERDAT', 5, '08879-3844', NULL, '003-780034-54');
INSERT INTO COMPANIES VALUES (6, 'ASC COMPANY', 6, '03/3451298', '567-345-453', '009-0000345-45');
INSERT INTO COMPANIES VALUES (9, 'TECHNISOFT B.V.', 9, '02977-22456', NULL, NULL);
INSERT INTO COMPANIES VALUES (10, 'BET MECHANICS NV.', 10 , '015/348778 ', '009-568-562', '021-0000456-78');
INSERT INTO COMPANIES VALUES (11, 'CandC INTERNATIONAL', 11, '01 278 2377', NULL, NULL);
INSERT INTO COMPANIES VALUES (12, 'BROWN AG', 12, '7-6566', NULL, NULL);
INSERT INTO COMPANIES VALUES (13, 'FLYGT', 13, '02/7800056', '900-120-324', '021-456098-45');
INSERT INTO COMPANIES VALUES (15, 'DIRECT SOFT Ltd.', 15 , '021 643 5072', NULL, NULL);
INSERT INTO COMPANIES VALUES (17, 'POUDRE BELGE', 17, '042/563409', '900-678-232', '009-4560004-56');
INSERT INTO COMPANIES VALUES (20, 'OLIVER', 20 , '011/459123', '451-546-789', '458-1285006-45');
INSERT INTO COMPANIES VALUES (21, 'PROCESS', 21, '03/3456723', '789-456-234', '410-4567894-67');
INSERT INTO COMPANIES VALUES (22, 'BELGISCHE BANK', 22, '03/3451078', '567-231-430', '554-4620439-45');
INSERT INTO COMPANIES VALUES (25, 'DIEMEN', 25, '01720-45665', NULL, NULL);
INSERT INTO COMPANIES VALUES (32, 'BERENDSEN CP', 32, '02/4568791', '125-002-021', '009-4587661-12');
INSERT INTO COMPANIES VALUES (41, 'RALBERG', 41, '071-218112', NULL, NULL);
INSERT INTO COMPANIES VALUES (42, 'EDUCA Ltd.', 42, '01 377 4645', NULL, NULL);
INSERT INTO COMPANIES VALUES (43, 'COMPUTRAIN', 43, '010-4134409', NULL, NULL);
INSERT INTO COMPANIES VALUES (46, 'ASSUR', 46, '091/450065', '021-102-212', '079-4580056-45');
INSERT INTO COMPANIES VALUES (52, 'BANC', 52, '02/4561236 ', '002-456-442', '079-0007549-05');
INSERT INTO COMPANIES VALUES (104, 'ASCO', 104, '0256 469460', NULL, '000-111111-54');
